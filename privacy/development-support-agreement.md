...
- ## Services 
    ...
    - One Development Support Pack shall include 100 hours. Upon expiration of the Development 
    ...
    - TDM will provide Development Support service based on a standard eight (8) hour working day
      and a standard forty (40) hour work week Monday through Friday from 11 AM to 8 PM Eastern 
      European time.
        
    - **One email.** You agree that TDM will accept Development Support requests from your one email 
...
- ## Results, Acceptance
    - The Development Support activities may result in provision of a Modified Framework.
    - The Modified Framework is deemed to be accepted when it is released as one of the official 
...
- ## Ownership
    - The Framework is owned by TeamDev Ltd., copyrighted and protected by copyright laws and 
    ...
    - The Modified Framework and any supplemental software code or related materials shall be 
...
- ## Indemnification
    - TDM will defend Customer against, and pay the amount of any adverse final judgment 
    ...
    - In the event either party receives information concerning a copyright infringement claim 
    ...
    - TDM will have no liability for any infringement or misappropriation claim based on Customer’s 
    ...
    - **Customer Indemnity.** You are responsible and will indemnify and holds TDМ harmless for any 
    ...
    - The foregoing states the parties’ exclusive liability and obligation arising out of any actual 
...
- ## Confidentiality
    ...
    - The receiving party (“Recipient”) shall protect the disclosing party’s (“Discloser”) 
    ...
    - Neither party shall have any obligation with respect to Confidential Information which:
        ...
        - was previously known to the receiving party or rightly received by a receiving 
        party from a third party;
        - is independently developed by the third party.
...
- ## Term and Termination
    - You may terminate this Agreement at any time by stopping using the Development Support.
    
    - We have the right to terminate this agreement without penalty to us in case of your abuse 
    of the Development Support or breach of this Agreement.
    
    - Neither party, shall by reason of the termination of this Agreement, be liable to the other 
    ...
    - Section 6 “NO WARRANTY,” 8 “Limitation of Liability,” 9 “Confidentiality,” and section 11 
    “Trademarks” shall remain effective after the termination of this Agreement.
    
- ## General Provisions
    - **Law**. The parties agree that this Agreement is governed by the laws of Republic of 
    ...
    - **Severability**. If any provision of this Agreement is deemed invalid by a court of 
    ...
    - **Notices**. By providing us your email address you consent to our using the email address 
