...
[list of pull requests]({{% get-site-data "spine.core_jvm_repo" %}}/pulls?utf8=%E2%9C%93&q=is%3Apr%20is%3Aclosed%20merged%3A2017-05-03T16%3A00%3A00%2B03%3A00..2017-10-17) and Javadocs.
...
For more details please see [#466]({{% get-site-data "spine.core_jvm_repo" %}}/pull/466).
...
For more details see [#580]({{% get-site-data "spine.core_jvm_repo" %}}/pull/580).

#### One-liner updates

- Base data types and utilities have been extracted into [`base` repository]({{% get-site-data "spine.base_libraries_repo" %}}).
