...
* [#1443]({{% get-site-data "spine.core_jvm_repo" %}}/pull/1443): 
...
* [#1448]({{% get-site-data "spine.core_jvm_repo" %}}/pull/1448): 
  Allow supplying `Executor` for `SystemWriteSide`.

* [#1454]({{% get-site-data "spine.core_jvm_repo" %}}/pull/1454): 
...
See [this PR]({{% get-site-data "spine.jdbc_storage_repo" %}}/pull/162) for more details.
