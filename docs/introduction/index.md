...
don't have to deal with DTOs. Developers of the client applications can write the code which
subscribes or queries these state types right after they are defied in the `.proto` files.   
