...
<?embed-code file="examples/hello/src/main/proto/hello/commands.proto" 
             start="*option (type_url_prefix)*" 
             end="*option (type_url_prefix)*"?>  
```proto
...
<?embed-code file="examples/hello/src/main/proto/hello/commands.proto" 
             start="*option java_package*" 
             end="*option java_package*"?>  
```proto
...
<?embed-code file="examples/hello/src/main/proto/hello/commands.proto" 
             start="*option java_outer_classname*" 
             end="*option java_outer_classname*"?>  
```proto
...
generated types.
<?embed-code file="examples/hello/src/main/proto/hello/commands.proto" 
             start="*option java_multiple_files*" 
             end="*option java_multiple_files*"?>  
```proto
