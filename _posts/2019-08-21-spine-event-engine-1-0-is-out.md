...
**Where do you start:**
Get a general overview of the framework [key concepts]({{site.baseurl}}/docs/introduction/concepts) or if you would rather see it working right away, take a look at the [examples](https://github.com/spine-examples/).
