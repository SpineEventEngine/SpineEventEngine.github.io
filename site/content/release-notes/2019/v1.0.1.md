...
mirror  — [#1138]({{% get-site-data "repositories.core_jvm_repo" %}}/pull/1138).
- The subscription registry synchronization was improved. Now the creation of the repetitive 
subscriptions to the same `Target` behaves as expected — [#1139]({{% get-site-data "repositories.core_jvm_repo" %}}/pull/1139).
